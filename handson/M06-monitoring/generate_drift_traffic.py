...
def main():
    ...
    print("")
    print("※ SageMaker Model Monitor は新規顧客に非公開のため、監視スケジュールは")
    print("  作成できません。AWS 公式の推奨代替は、オープンソースの SageMaker AI")
    print("  monitoring solutions（MLflow Apps + Evidently AI）+ QuickSight + CloudWatch です。")
